...
{
    /// <summary>Canonical names for scenes used by the application flow.</summary>
    public static class SceneNames
    {
        ...
        public const string Level04FacilityCore = "SCN_L04_FacilityCore";
        public const string DemoLevel = "SCN_DemoLevel";
        public const string Results = "SCN_Results";
        public const string TestPlayer = "SCN_Test_Player";
    }
}
